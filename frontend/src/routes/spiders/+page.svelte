<script lang="ts">
	...
	onMount(() => {
		selectedPage.set('spiders');
	});
</script>

<svelte:head>
	<title>Spiders</title>
	<meta name="description" content="Crawling significant web pages" />
</svelte:head>
	...
	>
		...
		<div class="mt-8">
			<h3 class="text-base font-semibold leading-6 text-gray-900">
				<a href="/spiders/azure" class="focus:outline-none">
			...
			<p class="mt-2 text-sm text-gray-500">
				check the 5 most recent release notes updates on Azure Command Line.
			</p>
		</div>
		<span
